plugins {
    ...
    id("org.jetbrains.kotlin.plugin.compose") // Enables Compose in Kotlin 2.0+
...
dependencies {
    ...
    implementation("com.google.firebase:firebase-firestore-ktx:24.6.0") // Firebase Firestore KTX
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.6.1") // ViewModel Compose support
